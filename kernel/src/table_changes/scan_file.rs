...
/// `(CDFScanFile, Option<Arc<HashMap<String, DvInfo>>>)`. The `CDFScanFile` is constructed by
/// visiting the engine data.
#[allow(unused)]
pub(crate) fn scan_data_to_scan_file(
    ...
    scan_data
        .map(|scan_data| -> DeltaResult<_> {
            ...
            Ok(result)
        }) // Iterator<DeltaResult<Iterator<(CDFScanFile, Option<Arc<HashMap<String, DvInfo>>>)>>>
        .flatten_ok() // Iterator<DeltaResult<(CDFScanFile, Option<Arc<HashMap<String, DvInfo>>>)>>
}
...
#[allow(unused)]
pub(crate) fn get_cdf_scan_row_expression(timestamp: i64, commit_number: i64) -> Expression {
            ...
            .map_ok(|actions| {
                engine
                    ...
                    .get_evaluator(
                        ...
                        get_cdf_scan_row_expression(1234, 42),
