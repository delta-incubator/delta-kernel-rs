...
mod tests {
    ...
    fn test_array_column() {
        ...
        let not_op = Expression::binary(BinaryOperator::NotIn, 5, simple_column!("item"));

        let in_op = Expression::binary(BinaryOperator::In, 5, simple_column!("item"));
    ...
    fn test_bad_right_type_array() {
        ...
        let in_op = Expression::binary(BinaryOperator::NotIn, 5, simple_column!("item"));
    ...
    fn test_str_arrays() {
        ...
        let str_not_op = Expression::binary(BinaryOperator::NotIn, "bye", simple_column!("item"));

        let str_in_op = Expression::binary(BinaryOperator::In, "hi", simple_column!("item"));
