...
#[test]
fn type_widening_nested() -> Result<(), Box<dyn std::error::Error>> {
    let expected = vec![
        "+--------------------------+--------------------------------------------+---------------------------------------------+",
        "| struct                   | map                                        | array                                       |",
        "+--------------------------+--------------------------------------------+---------------------------------------------+",
        "| {a: 1}                   | {2: 3}                                     | [4, 5]                                      |",
        "| {a: 9223372036854775807} | {9223372036854775807: 9223372036854775807} | [9223372036854775807, -9223372036854775808] |",
        "+--------------------------+--------------------------------------------+---------------------------------------------+",
    ];
    read_table_data_str("./tests/data/type-widening-nested/", None, None, expected)?;
    Ok(())
}
